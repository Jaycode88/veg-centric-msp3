...
$(document).ready(function() {
    ...
    addIngredientButton.on("click", function(event) {
      ...
      const newIngredient = $("<div class='ingredient'>" +
        ...
        "<button class='removeButton btn small waves-effect deep-orange accent-2 waves-light'>Remove</button><br>" +
        "</div>");
  ...
  $(document).ready(function() {
    ...
    addMethodStepButton.on("click", function(event) {
      ...
      const newMethodStep = $("<div class='method-step'>" +
        ...
        "<button class='removeButton btn small waves-effect deep-orange accent-2 waves-light'>Remove</button>" +
        "</div>");
